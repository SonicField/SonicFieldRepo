...
from organ.Voices import clarion as voice2
from organ.Voices import string  as voice3
from organ.Voices import celest_flute as voice4
import random
import math
...
mins = 60
scnt = 4
voce = (voice1,voice2,voice3,voice4)
sigs = [
