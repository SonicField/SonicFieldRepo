...
public class SF_PhasedTableSin implements SFPL_Operator
{
    ...
    public static class Generator extends SFSimpleGenerator
    {
        ...
        {
            return SFMaths.tableSin(index * mult + phase);
        }
    }
    ...
    public String Word()
    {
        return Messages.getString("SF_PhasedTableSin.0"); //$NON-NLS-1$
    }
