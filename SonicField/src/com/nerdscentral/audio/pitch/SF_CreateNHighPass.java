...
public class SF_CreateNHighPass implements SFPL_Operator
{
    ...
    public String Word()
    {
        return Messages.getString("SF_CreateNHighPass.0"); //$NON-NLS-1$
    }
    ...
    public Object Interpret(Object input) throws SFPL_RuntimeException
    {
        ...
        NPoleFilterDef fdIn = SFFilterGenerator.computeButterworthNHP(frequency, order);
        return new SFInLineIIRFilter(fdIn, fdIn.getGainhf());
    }
