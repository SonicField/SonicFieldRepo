...
public class SF_BiquadBandPass implements SFPL_Operator
{
    ...
    public String Word()
    {
        return Messages.getString("SF_BiquadBandPass.0"); //$NON-NLS-1$
    }
    ...
    public Object Interpret(Object input) throws SFPL_RuntimeException
    {
        ...
        FilterType type = FilterType.BANDPASS_PEAK;
